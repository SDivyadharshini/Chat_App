   ...
   Boolean typing;
    ...
    Client()
    {
      f1.setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/nivi.png"));
    ...
    public static JPanel formatLabel(String out){
        ...
        l1.setBackground(new Color(77, 72, 69));
