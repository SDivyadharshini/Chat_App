...
public class Server implements ActionListener{
  ...
  Boolean typing;
    ...
    Server()
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/ddd.png"));
    ...
    public static JPanel formatLabel(String out){
        ...
        l1.setBackground(new Color(158, 214, 134));
